...
class UserRegistration {
    ...
    public void addUser(String username, String password) {
        ...
        users.add(newUser);
        System.out.println("User '" + username + "' telah berhasil terdaftar.");
    }
    ...
    public boolean loginUser(String username, String password) {
        ...
        System.out.println("Login gagal! Periksa kembali username atau password Anda.");
        return false;
    }
}
...
class penawarantertinggi {
    double penawaranTertinggi;

    public void setPenawaranTertinggi(double penawaranTertinggi) {
        this.penawaranTertinggi = penawaranTertinggi;
    }
...
class Barang {
    ...
    public Barang(int idBarang, String namaBarang, double hargaTawar, String status, double hargaAwal,
            double penawaranTertinggi) {
    ...
    public void hargaAwal(double hargaAwal) {
        this.hargaAwal = hargaAwal;
    }
    ...
    public void setpenawarantertinggi(double penawaranAnda) {
    }
}
...
class Lelang {
    ...
    public Barang getDataBarangByCode(String code) {
        return null;
    }

    public void setupDefaultUsers() {
        registration.addUser("user1", "password1");
        registration.addUser("user2", "password2");
    }
    ...
    public void loginUser() {
        ...
        boolean loginSuccess = registration.loginUser(username, password);
    ...
    public void MenuUser() {
        ...
        System.out.println("2. Ajukan penawaran ");
        System.out.println("3. Lihat Pemenang Lelang");
        System.out.println("=============================================");
    ...
    private void ajukanPenawaran() {
        System.out.print("Masukkan kode barang yang ingin diajukan penawaran : ");
        String code = input.next();
        Lelang lelang = new Lelang();
        Barang penawarantertinggi = lelang.getDataBarangByCode(code);

        if (penawarantertinggi != null) {
            double hargaAwal = penawarantertinggi.getHargaAwal();
            System.out.printf("Harga awal adalah Rp %.2f \n", hargaAwal);
            System.out.print("Masukkan harga penawaran Anda : ");
            double penawaranAnda = input.nextDouble();
            if (penawaranAnda <= hargaAwal) {
                System.out.println("Harga penawaran harus lebih tinggi dari harga awal!");
            } else {
                penawarantertinggi.setpenawarantertinggi(penawaranAnda);
                System.out.println("Penawaran Anda berhasil terkirim.");
            }
        } else {
    ...
    public void registrasiUser() {
        ...
        registration.addUser(username, password);
    ...
    public void menu() {
        int pilihan = 0;
        while (pilihan != 4) {
            System.out.println("===== WELCOME TO BIDDING APPLICATION =====");
            ...
            switch (pilihan) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Exiting bidding application...");
                    System.exit(0);
                    break;
                default:
                    System.out.println("Invalid input\n");
    ...
    public void tambahBarang() {
        ...
        System.out.println("Masukkan harga tawar baru : ");
        double hargaTawar = input.nextDouble();
        System.out.println("Masukkan penawaran tertinggi anda : ");
        double penawaranTertinggi = input.nextDouble();
        int id;
        if (!arrBarang.isEmpty()) {
        ...
        Barang b = new Barang(id, nama, hargaAwal, status, hargaTawar, penawaranTertinggi);
        arrBarang.add(b);
