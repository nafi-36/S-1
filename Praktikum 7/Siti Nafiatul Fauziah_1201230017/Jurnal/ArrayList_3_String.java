...
public class ArrayList_3_String {
    ArrayList<String> arrList = new ArrayList<String>();
    Random getRandom = new Random();

    public static void main(String[] args) {
        ArrayList_3_String al3_2 = new ArrayList_3_String();
        al3_2.inputData();
        al3_2.viewData();
        al3_2.reverseViewData();
        al3_2.exampleMethods();
    }
    ...
    void inputData() {
        ...
        while (jml < 10) {
            ...
            arrList.add(String.valueOf(inputan)); // Penambahan data ke ArrayList
            jml++;
        }
    }
    ...
    void viewData() {
        ...
        while (a < arrMax) {
            ...
            String nilai = String.valueOf(arrList.get(a));
